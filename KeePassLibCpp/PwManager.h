...
#define PWM_DIR_LANGUAGES _T("Languages")
#define PWM_DIR_PLUGINS   _T("Plugins")
...
#define PWMKEY_PASSWORDFONT         _T("KeePasswordFont")
...
#define PWKI_DIRECT_1 0x44A7E4BC337F4149ULL
#define PWKI_DIRECT_2 0xA67F3A5282107004ULL
