	...
	public sealed partial class XmlSerializerEx : IXmlSerializerEx
	{
			...
			while(true)
			{
				...
				switch(xr.LocalName)
				{
					case "ProfilesEnabled":
						o.ProfilesEnabled = ReadBoolean(xr);
						break;
			...
			while(true)
			{
				...
				switch(xr.LocalName)
				{
					...
					case "UrlOverride":
						...
						break;
					case "UrlOverrideEnabled":
						o.UrlOverrideEnabled = ReadBoolean(xr);
						break;
		...
		private static KeePass.UI.BannerStyle ReadBannerStyle(XmlReader xr)
		{
			if(m_dictBannerStyle == null)
			{
				...
				m_dictBannerStyle["Blue"] = KeePass.UI.BannerStyle.Blue;
				m_dictBannerStyle["WinXPLogin"] = KeePass.UI.BannerStyle.WinXPLogin;
				m_dictBannerStyle["Dark"] = KeePass.UI.BannerStyle.Dark;
				m_dictBannerStyle["WinVistaBlack"] = KeePass.UI.BannerStyle.WinVistaBlack;
				m_dictBannerStyle["Light"] = KeePass.UI.BannerStyle.Light;
